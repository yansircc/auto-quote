import {
  ...
  runPositionDistributionOptimizer,
  runShapeSimilarityOptimizer,
  runSpaceUtilizationOptimizer,
  runSpacingUniformityOptimizer,
...
const OPTIMIZERS: OptimizerConfig[] = [
  ...
  },
  {
    ...
    description: "位置分布优化器",
    weight: 0.33,
    run: runPositionDistributionOptimizer,
  },
  {
    name: "shapeSimilarity",
    description: "形状相似度优化器",
    weight: 0.15,
    run: runShapeSimilarityOptimizer,
  },
  {
  ...
  },
  {
    ...
    weight: 0.2,
    run: runSpacingUniformityOptimizer,
  },
  {
    name: "symmetry",
    description: "对称性优化器",
...
// # 运行所有优化器
// bun run src/lib/quote-price/mold/layout/balance/runner/run-optimizer.ts

// # 运行特定优化器
// bun run src/lib/quote-price/mold/layout/balance/runner/run-optimizer.ts symmetry
