...
import { getProductMaterial, calculateProductMaterialCost } from "../product-materials";
...
describe('产品材料测试', () => {
  ...
  describe('calculateProductMaterialCost', () => {
    ...
    it('应正确处理小体积产品的成本', () => {
      ...
      const expectedCost = actualVolume * mockMaterial.density * mockMaterial.pricePerKg;
